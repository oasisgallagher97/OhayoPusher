...
def send_message(to_user, access_token, city_name, weather, max_temperature, min_temperature):
    ...
    caihongpi = requests.get('https://apis.tianapi.com/caihongpi/index?key=f8830aa408f8b610df911d01022d7688')
    print(caihongpi.content.decode())
    caihongpi = json.loads(caihongpi.content.decode())['result']['content']
    print(caihongpi)
